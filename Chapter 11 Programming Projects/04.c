...
void analyze_hand(bool *straight, bool *flush, bool *royal_flush, bool *four, bool *three, int *pairs);
void print_result(bool *straight, bool *flush, bool *royal_flush, bool *four, bool *three, int *pairs);

int main(void)
{
  bool straight = true, flush = true, royal_flush = false, four = false, three = false;
  int pairs = 0;  

  for (;;) {
    read_cards();
    analyze_hand(&straight, &flush, &royal_flush, &four, &three, &pairs);
    print_result(&straight, &flush, &royal_flush, &four, &three, &pairs);
  }
}
