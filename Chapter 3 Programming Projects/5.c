...
int main(void)
{
  ...
  int row_sum1 = one + two + three + four,
      ...
      column_sum1 = one + five + nine + thirteen,
      column_sum2 = two + six + ten + fourteen,
      column_sum3 = three + seven + eleven + fifteen,
      column_sum4 = four + eight + twelve + sixteen,
      diagonal_sum1 = one + six + eleven + sixteen,
      diagonal_sum2 = four + seven + ten + thirteen;
